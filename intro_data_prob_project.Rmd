...
It is well known that people with Arthritis feels lots of pain and in many cases it can turn their lives into a nightmare because they cannot do basic things such as walking, bathing, going to a market and so on. For this reason I will check the impact of this disease on people's lives.

**Research quesion 2:**

Diabetes is one of the main responsible for blindness caused by a disease among the adult population around the world and thinking about that I decided to compare and analyse the relation between the illness and blindness in USA. Moreover, I will check if people who have diabetes and are blind were told about the relation between both of them.

**Research quesion 3:**

The last question I will approach is there is any relation among sleep disorders, depression and hypertension because according to (Batal et al., 2011) these disorders are a risk factor for both high blood pressure and depression.
...
Secondly I separated the object, that contains 491.775 parameters, into two where the first one is related to people without arthritis and the another one concerns people with because I wanted to show the huge difference that exists between these two groups when it comes to problems caused by this disease. Once I got the data I was looking for I created two different plots regarding people with and without arthritis.
...
And I made a plot using ggplot showing the amount of problems people without arthritis said they have. Note that these 3 problems are the ones I mentioned above: 

- Difficulty Walking Or Climbing Stairs; 
- Difficulty Dressing Or Bathing; 
- Difficulty Doing Errands Alone.

If a person said he or she had some issue to walk or wear a t-shirt for example, he/she got 1 in the respective variable. As I explained at the beginning, I changed the "yes/no" answers to 1/0 where 1 stands for "yes" and 0 for "no" due to it is easier to work and use data like that.
...
As we can see, the majority of people without the disease has no problems (0) that are commonly related to it. The result was very satisfactory because we were waiting for numbers like that. Below we have a summary of the finds:
...
-   Less than 1% said they were facing all the 3 problems, it is a very low number.
...
As expected due to the previous outcomes, there are 165.152 people out of 491.775 with arthritis which represents 33.58% of total.
...
The plot shows a completely different pattern in comparison to the first one. In this one we can see there is a huge amount of people with daily problems caused by the disease.
...
This outcome was expected because people with the illness usually have some difficulty to do some daily activities, even the basic ones like walking or wearing a shirt or pant. You can see below a table showing all the results, including the percentage:
...
The amount of people who finds some activities very difficult due to joint pain increased significally as expected because people on this sample have arthritis. We saw in the first graph that more than 90% of people without the disease had no issues with pain, while in this one the percentage drops to 60%.
...
```
Visualization of the finds above:
...
```
 ...
 And I finally got above the result I was looking for:
 ...
 Perhaps if people had more knowledge about that, many of them could have avoided losing their vision.


**Research quesion 3:**

Firstly I need to select and organize the variables I want to work with. In this question I will select the following ones: 
...
We can see 32.27% of the people in the sample (158.695) can potentially have some sleep disorder like insomnia, narcolepsy or sleep apnea.  

Now I summarized my dataset to facilitate my data analysis. I will only select people who suffers at least of one of both diseases mentioned in this study and will sum the amount of people according to their sleep hours. 
...
with the dataset above I could find how many people who sleep less than 6 hours suffer of either hypertension or depression, or even both. 
...
The finds of this analysis is quite chocking because more than half of the sample has a disease that is highly connected to a poor sleep habit. 

Now I just need to merge the "insomnia_summary1" dataframe to the "insomnia_summary2" to be able to create a proper plot about the results I want to. 
...
Finally I can generate my plot about the relation among sleep disorders and hypertension/depression
...
As we can see, there is a clear relation between poor sleep habits to hypertension and depression. The less hours someone sleeps, the more chance to he or she has to develop a disease associated to that.

According to the graph:

- 68% of people who sleep only 2 hours a day have at least one of both illnesses;
...
PS. I am not taking into consideration the 100% concerning 1 hour sleep because there was only one individual in the sample and it is not statistically relevant. 
